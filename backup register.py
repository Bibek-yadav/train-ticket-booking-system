...
class Signup:
        ...
        try:
            ...
            if first_name == '' or last_name == '' or username == '' or password == '' or phone == '' or address == '':
                ...
                if tup != -1:
                    ...
                    messagebox.showinfo('Done', ' Signuped successfully!')
                    return True
        except Exception as e:
            print(e)
    ...
    def mainsc(self):
        try:
            self.window2=Tk()
            self.window2.title('Railway Ticket Booking system')
            ...
            self.but = Button(self.window2, text="SIGNUP", command=self.reg, bg='light green', height="2",width="30" ,font="Bold 10")
            self.but.pack()
