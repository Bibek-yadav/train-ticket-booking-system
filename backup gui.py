...
class Train():
    ...
    def main(self):
        try:
            ...
            self.lbl = Label(self.wn, text="Select Your Choice", bg="red", width="300", height="2",
                             font=("Bold", 15)).pack()
            self.btn = Button(self.wn, text="Register train ticket", width=30, font="Bold 10", bg="dark blue", fg="black",
                              command=self.register_train)
            self.btn.pack()
            self.btn1 = Button(self.wn, text="Search the train ticket", width=30, font="Bold 10", bg="dark blue", fg="black",
    ...
    def register_ticket(self):
        try:
            ...
            self.lbl = Label(self.wn1, text="Train ticket company: ", fg="dark blue", width=15,
                             font=("arial", 12, "bold"))
            self.lbl.grid(row=0, column=0)
            self.entry_ac = Entry(self.wn1, width=35)
            self.entry_ac.grid(row=0, column=1)

            self.p = Label(self.wn1, text="train model: ", fg="red", width=15,
                           font=("arial", 12, "bold"))
            self.p.grid(row=1, column=0)
            self.entry_p = Entry(self.wn1, width=35)
            self.entry_p.grid(row=1, column=1)

            self.combo = [ "Ktm to Birjung" "Nepalgunj to Pokhara", "Palpa to Kathmandu",
                          "Pokhara to KTM ", "Chitwan to KTM","Birgunj to Ktm" "Janakpur to KTM"]
            self.b = Label(self.wn1, text=" train Route: ", fg="dark purple", width=15, font=("arial", 12, "bold"))
            ...
            self.upd = Button(self.wn1, text="Add", width=10, height=1, font=("arial", 12, "bold"),
                              fg="black", command=self.register_train)
