...
class Railway():
    ...
    def main(self):
        try:
            ...
            self.wn.title("Railway Ticket Booking System")
            self.wn.geometry("515x500")
            self.wn.configure(bg="limegreen")
            self.lbl = Label(self.wn, text="Select Your Choice", bg="orange", width="300", height="2",
                             font=("Bold", 15)).pack()
            self.btn = Button(self.wn, text="Register train", width=30, font="Bold 10", bg="yellow", fg="black",
                              command=self.register_train)
            self.btn.pack()
            self.btn1 = Button(self.wn, text="Search the train", width=30, font="Bold 10", bg="yellow", fg="black",
    ...
    def register_train(self):
        try:
            ...
            global wn1
            self.wn1 = Toplevel()
            self.wn1.title("Welcome customer to  yadav Railways Booking")
            self.wn1.geometry("1300x380")
            self.wn1.configure(bg="lightblue")

            self.lbl = Label(self.wn1, text="Railway company: ", fg="darkblue", width=15,
                             font=("arial", 12, "bold"))
            self.lbl.grid(row=0, column=0)
            self.entry = Entry(self.wn1, width=35)
            self.entry.grid(row=0, column=1)

            self.p = Label(self.wn1, text="train model: ", fg="darkblue", width=15,
                           font=("arial", 12, "bold"))
            ...
            self.b = Label(self.wn1, text=" train Route: ", fg="darkblue", width=15, font=("arial", 12, "bold"))
            ...
            self.tc = Label(self.wn1, text="Price ", fg="darkblue", width=15, font=("arial", 12, "bold"))
            self.tc.grid(row=6, column=0)
            self.entry_tc = Entry(self.wn1, width=35)
            self.entry_tc.grid(row=6, column=1)

            self.Ph = Label(self.wn1, text="No. of seats: ", fg="darkblue", width=15, font=("arial", 12, "bold"))
            self.Ph.grid(row=7, column=0)
            self.entry_st = Entry(self.wn1, width=35)
            self.entry_st.grid(row=7, column=1)

            self.des = Label(self.wn1, text="Description: ", fg="darkblue", width=15,
                             font=("arial", 12, "bold"))
            ...
            self.view_tree.heading('d', text='Price')
            ...
            self.upd = Button(self.wn1, text="Add", width=10, height=1, font=("arial", 12, "bold"),
                              fg="black", command=self.register_train1)
    ...
    def register_train1(self):
        try:
            company = self.entry.get()
    ...
    def select_train(self, event):
        try:
            ...
            self.entry.insert(0, selected_data[0])
    ...
    def update_item(self):
        try:
            ...
            if self.index == "":
                ...
                if self.update_train(int(self.index), company, model, route, price, seat, des):
...
class Searchtrain:
    ...
    def searchgui(self):
        ...
        try:
                self.wn1 = Toplevel()
                self.wn1.title("Welcome user to our Searching the train")
                self.wn1.geometry("1300x380")
                ...
                self.p = Label(self.wn1, text="train model: ", fg="dark blue", width=15,
                               font=("arial", 10, "bold"))
                self.p.place(x=30, y=190)
                self.entry_p = Entry(self.wn1)
                self.entry_p.place(x=190, y=190)

                self.b = Label(self.wn1, text=" train Route: ", fg="dark blue", width=15, font=("arial", 10, "bold"))
    ...
    def gene_tic(self):
        try:
            ...
            self.lbl = Label(self.wn7, text="yadav Railway Services", fg="dark blue",bg='pink',
                             font=("arial", 15, "bold"))
            self.lbl.place(x=60, y=30)

            self.lbl = Label(self.wn7, text="train-Ticket", fg="dark blue",bg='pink',
                             font=("arial", 10, "bold"))
            ...
            self.b = Label(self.wn7, text=" train Route: ", fg="dark blue", font=("arial", 10, "bold"))
            ...
            self.citi = Label(self.wn7, text="Time of train ", fg="dark blue", font=("arial", 10, "bold"))
            ...
            self.datent.insert(0,self.today)
